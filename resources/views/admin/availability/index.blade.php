<x-layouts.admin>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="h3 fw-bold mb-0">Manage Availability</h2>
            <p class="text-muted">You are managing the schedule for: <strong>{{ $doctor->name }}</strong></p>
        </div>
        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#addBlockModal">+ Block Range</button>
    </div>
   ...
   <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 2000)" x-cloak>
    ...
    <div>
        ...
        <div class="row" id="schedule-list-container"></div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content custom-modal-content">
                <div class="custom-modal-header">
                    ...
                    <h4 class="modal-title">Block Time Slot for {{ $doctor->name }}</h4>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body p-4">
                    <form action="{{ route('admin.availability.store', $doctor) }}" method="POST">
                        @csrf
                        <div class="mb-3"><label for="start_time" class="form-label">Start Time</label><input type="datetime-local" name="start_time" class="form-control" required></div>
                        <div class="mb-3"><label for="end_time" class="form-label">End Time</label><input type="datetime-local" name="end_time" class="form-control" required></div>
                        <div class="mb-3"><label for="reason" class="form-label">Reason (Optional)</label><input type="text" name="reason" class="form-control" placeholder="e.g., Lunch Break, Meeting"></div>
